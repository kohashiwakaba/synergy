...
public class Main_1 extends Fragment {
    ...
    private void initNews(){
        ...
        mn = new ArrayList<>();
        mn.add(new Main_News(R.drawable.demo_icon,"추천","추천 카페 BEST 3","2018/04/01",false,R.drawable.demo_m1,"22","8"));
        mn.add(new Main_News(R.drawable.demo_icon,"박람회","TV 웨딩 박람회","2018/12/04",false,R.drawable.demo_m2,"12","9"));
